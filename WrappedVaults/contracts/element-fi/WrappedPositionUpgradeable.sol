...
import "./interfaces/IWrappedPositionUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/extensions/draft-ERC20PermitUpgradeable.sol";

/// @author Element Finance
/// @title Wrapped Position Core
abstract contract WrappedPositionUpgradeable is
    Initializable,
    ...
    IWrappedPosition
{
    ...
    function __WrappedPositionUpgradeable_init(
        address _token,
        string memory _name,
        ...
        _decimals = ERC20PermitUpgradeable(_token).decimals();
    }
