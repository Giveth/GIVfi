...
// File contracts/element-fi/interfaces/IERC20.sol
...
// File contracts/element-fi/libraries/Authorizable.sol
...
// File contracts/element-fi/interfaces/IWETH.sol
...
// File contracts/element-fi/interfaces/IERC20Permit.sol
...
// File contracts/element-fi/interfaces/IWrappedPosition.sol
...
// File contracts/element-fi/libraries/ERC20Permit.sol
...
// File contracts/element-fi/WrappedPosition.sol
...
// File contracts/BeefyV6AssetProxy.sol
...
contract BeefyV6AssetProxy is WrappedPosition, Authorizable {
    ...
    /// @param vault_ The beefy v6 vault
    /// @param _token The underlying token.
    ///               This token should revert in the event of a transfer failure.
    ...
    function _withdraw(
        ...
        // The amount received is the difference between the before and after
        uint256 amountReceived = amountAfter - amountBefore;

        // Transfer the funds to the destination
    ...
    function transition(IBeefyV6 newVault, uint256 minOutputShares)
        external
        onlyOwner
    {
        ...
        uint256 newPricePerShare = newVault.getPricePerFullShare();
        ...
        uint256 sharesBefore = newVault.balanceOf(address(this));
        newVault.deposit(currentBalance);
        uint256 sharesAfter = newVault.balanceOf(address(this));
        uint256 outputShares = sharesAfter - sharesBefore;
...
// File contracts/GIVfiWrappedBeefyV6Vault.sol

// -Identifier: Apache-2.0
pragma solidity ^0.8.17;

contract GIVfiWrappedBeefyV6Vault is BeefyV6AssetProxy {
    ...
    ) BeefyV6AssetProxy(vault_, _token, _name, _symbol, _governance, _pauser) {
        fee = _fee;
