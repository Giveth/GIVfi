...
import "../../src/DonationHandler/DonationHandlerBridgeable.sol";
import "../mocks/MockERC20.sol";

contract SharedInitializationBridgeable is Test {
    address deployer = 0xb4c79daB8f259C7Aee6E5b2Aa729821864227e84;
    address public constant NATIVE = address(0);

    DonationHandlerBridgeable public donationHandler;
    ...
    function _initializeVariables() internal {
        ...
        donationHandler = new DonationHandlerBridgeable();
    ...
    function _initializeDonationHandler() internal {
        ...
        donationHandler.initialize(acceptedToken, donationRecipient, feeReceiver, admins, 1e17, address(0), false);
    }
}
